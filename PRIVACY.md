...
PhactoryFit 1.10.0 does not collect email addresses, passwords, payment details, precise location, contacts, body photographs, government identifiers, or medical records. Features that add cloud storage, wearable health data, photos, or accounts require an updated privacy notice and security review before release.
...
## Restaurant location setting in 1.10.0
