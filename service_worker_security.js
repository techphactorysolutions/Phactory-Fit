...
global.caches = {
  ...
  async keys() { return ['old-cache', 'phactoryfit-v1.11.0']; },
...
(async () => {
  ...
  assert(addAll[1].includes('./zxing-browser.min.js?v=1.11.0'), 'scanner must be in the required shell');
  assert(addAll[1].includes('./app.js?v=1.11.0'), 'app code must be in the required shell');
  ...
  assert.equal(codePut[1], 'https://example.test/phactoryfit/app.js?v=1.11.0');
